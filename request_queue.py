...
class QueueItem:
    ...
    messages: list[dict] = dataclasses.field(compare=False, default_factory=list)
...
class RequestQueue:
    ...
    async def enqueue(self, engine: str, prompt: str, tier: str, max_tokens: int, response_queue: asyncio.Queue, messages: list[dict] = None) -> str:
        """
